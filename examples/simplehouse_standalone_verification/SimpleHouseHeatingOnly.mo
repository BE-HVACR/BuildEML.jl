...
model SimpleHouseHeatingOnly
  ...
  Buildings.Fluid.Sources.Boundary_pT bouWat(redeclare package Medium =
      ...
      Placement(transformation(extent={{-10,-10},{10,10}}, origin={20,-180})));
...
a proportional-controller instead of a hysteresis controller.
    ...
    __Dymola_Commands(file=
        ...
        "Simulate and plot"),
    uses(Modelica(version="4.0.0"), Buildings(version="11.0.0")));
end SimpleHouseHeatingOnly;
